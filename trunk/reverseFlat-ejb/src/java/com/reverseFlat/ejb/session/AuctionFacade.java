...
import com.reverseFlat.ejb.persistence.Pricebyauction;
import com.reverseFlat.ejb.persistence.PricebyauctionPK;
...
public class AuctionFacade implements AuctionFacadeLocal, AuctionFacadeRemote {
    ...
    public Auction find(Object id) {
        ...
        q.executeUpdate();
        return em.find(com.reverseFlat.ejb.persistence.Auction.class, id);
    }
