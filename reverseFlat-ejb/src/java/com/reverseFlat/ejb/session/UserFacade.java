...
import com.reverseFlat.ejb.commons.utils.PayPalUtil;
import com.reverseFlat.ejb.commons.utils.SnoofMail;
...
import com.reverseFlat.ejb.persistence.Grouptable;
import com.reverseFlat.ejb.persistence.Registermailpage;
...
public class UserFacade implements UserFacadeLocal, UserFacadeRemote {
    ...
    public User find(Object id) {
        return em.find(com.reverseFlat.ejb.persistence.User.class, id);
    }
